...
var _Urknall = require('states/Urknall');

var _Urknall2 = _interopRequireDefault(_Urknall);
...
var Game = function (_Phaser$Game) {
	...
	function Game() {
		...
		var _this = _possibleConstructorReturn(this, (Game.__proto__ || Object.getPrototypeOf(Game)).call(this, window.innerWidth, window.innerHeight, Phaser.AUTO));

		_this.state.add('Urknall', _Urknall2.default, false);
...
},{"states/Urknall":3}],2:[function(require,module,exports){
"use strict";
